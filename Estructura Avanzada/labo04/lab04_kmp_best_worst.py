...
for i in range(exp_repeat_times):
	kmp_times_txt1.append(kmp_time(pat1,txt1))
...
for i in range(exp_repeat_times):
	kmp_times_txt2.append(kmp_time(pat2,txt2))
...
for i in range(exp_repeat_times):
	kmp_times_txt3.append(kmp_time(pat3,txt3))
...
for i in range(exp_repeat_times):
	kmp_times_txt4.append(kmp_time(pat4,txt4))
...
# plt.show()
plt.title('Knuth-Morris-Pratt(KMP)')
